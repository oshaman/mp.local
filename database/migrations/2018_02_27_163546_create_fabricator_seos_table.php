...
class CreateFabricatorSeosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fabricator_seos', function (Blueprint $table) {
            $table->increments('id');

            $table->unsignedInteger('fabricator_id');
            $table->foreign('fabricator_id')->references('id')->on('fabricators')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('fabricator_seos');
    }
}
